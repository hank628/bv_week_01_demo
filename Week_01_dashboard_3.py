...
# 2️⃣ App 標題
# -------------------------------
st.title("NBA 四圖互動 Dashboard 範例")

# -------------------------------
# 3️⃣ 使用者選擇
# -------------------------------
metric_options = ['得分', '助攻', '籃板', '效率']
metric1 = st.selectbox("選擇折線圖指標", metric_options)
metric2 = st.selectbox("選擇長條圖指標", metric_options)
metric3 = st.selectbox("選擇圓餅圖指標", ['球隊', '球員'])
metric4 = st.selectbox("選擇雷達圖指標", metric_options)
